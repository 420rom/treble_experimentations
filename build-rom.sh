...
if [ "$rom" == "lineage15" ];then
	...
	repo init -u ssh://git@github.com/LineageOS/android.git -b lineage-18.1
...
mkdir patches
wget ssh://git@github.com/phhusson/treble_experimentations/releases/download/v310/patches.zip
